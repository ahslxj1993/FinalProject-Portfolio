 ...
 <div class="container mb-5" style="height:1100px;">
  <div class="row px-xl-5">
   ...
   <tr style="border:none">
     <th colspan="3" class="text-left"><span class="commu">&emsp;공지사항 수정&nbsp;</span><i class="fas fa-exclamation-circle"></i></th>
...
action="${pageContext.request.contextPath}/admin/admin_write_notice_update_Action" enctype="multipart/form-data">

   <sec:authorize access="isAuthenticated()">
   <sec:authentication property="principal" var="pinfo"/>
     <input type="hidden" name="ABN_NAME" value="${pinfo.username}">
     <b>제목</b>
     <input class="jinput" type="text" name="ABN_SUBJECT" placeholder="제목을 입력해 주세요." maxlength="50"
     value ="${abn.ABN_SUBJECT}" required>
     ...
     <b class="mt-3">내용</b>
     <textarea id="summernote" name="ABN_CONTENT" >"${abn.ABN_CONTENT}"</textarea>
    ...
    <input type="hidden" name="ABN_NUMBER" value="${abn.ABN_NUMBER}" >
</form>
